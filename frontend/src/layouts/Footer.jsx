      ...
      <div className="row">
        <aside className="col-md-4">
          <article className="mr-3">
            <img src={require("../assets/images/logo.png")} className="logo-footer" />
        ...
        <aside className="col-sm-2  col-md-2">
          ...
          <a href="#" className="d-block mb-2"><img src={require("../assets/images/misc/appstore.png")} height={40} /></a>
          <a href="#" className="d-block mb-2"><img src={require("../assets/images/misc/playmarket.png")} height={40} /></a>
        </aside>
      </div> {/* row.// */}
    </section>	{/* footer-top.// */}
